...
describe('uploaderFieldsFromTenant', () => {
  it('maps a tenant doc to name/logo/brandColor', () => {
    expect(uploaderFieldsFromTenant({ organizationName: 'Acme', logoUrl: 'http://x/l.png', brandColor: '#112233' }))
      .toEqual({ createdByTenantName: 'Acme', createdByTenantLogoUrl: 'http://x/l.png', createdByTenantBrandColor: '#112233' });
  });
