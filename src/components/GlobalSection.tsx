...
export default function GlobalSection() {
  ...
  return (
    <section className="relative py-20 md:py-48 overflow-x-hidden">
      ...
      <div className="absolute inset-0 bg-stripe-light" style={{ bottom: '50%' }} />
      ...
      <div
        className="absolute bg-stripe-blue"
        style={{
          top: 0,
          left: 0,
          right: 0,
      ...
      <div className="max-w-7xl mx-auto px-6 relative">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <p className="text-stripe-cyan font-semibold text-sm uppercase tracking-wider mb-4">
            ...
            <div className="flex flex-wrap gap-4">
              <a
                href="#"
                className="inline-flex items-center gap-2 text-stripe-cyan hover:text-white text-sm font-medium transition-colors"
              >
