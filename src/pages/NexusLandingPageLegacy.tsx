...
// ─── Main Landing Page ───────────────────────────────────────────────────────
export default function NexusLandingPageLegacy() {
  const { language } = useLanguage();
  const he = language === 'he';

  // Legacy snapshot of the welfare page, kept for side-by-side comparison only.
  // Canonical points at its own preview path so it never competes with /welfare.
  useSEO({
    title: he ? 'Nexus | רווחה (גרסה ישנה)' : 'Nexus | Welfare (Legacy)',
    description: he
    ...
    canonical: he ? 'https://nexus-payment.com/he/welfare-legacy' : 'https://nexus-payment.com/welfare-legacy',
    alternates: {
      he: 'https://nexus-payment.com/he/welfare-legacy',
      en: 'https://nexus-payment.com/welfare-legacy',
    },
  });
